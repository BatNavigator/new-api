...
func SetApiRouter(router *gin.Engine) {
	...
	apiRouter.Use(middleware.GlobalAPIRateLimit())
	{
		...
		apiRouter.GET("/workbuddy/models", middleware.UserAuth(), controller.GetWorkBuddyModels)
		apiRouter.GET("/workbuddy/protocol", middleware.UserAuth(), controller.GetWorkBuddyProtocolName)
		apiRouter.GET("/workbuddy/installer", middleware.UserAuth(), controller.GetWorkBuddyInstaller)
		...
		userRoute := apiRouter.Group("/user")
		{
			...
			selfRoute.Use(middleware.UserAuth())
			{
				...
				selfRoute.GET("/group_models", controller.GetUserGroupModels)
